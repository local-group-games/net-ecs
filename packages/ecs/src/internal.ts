...
export const INTERNAL_$componentAdminComponentPools = Symbol(
...
export const INTERNAL_$entityAdminComponentAdmin = Symbol(
...
// Tools
export const INTERNAL_worldCreated = new Signal<World<any>>()
